    ...
    >
      <li className='hover:bg-gray-100 dark:hover:bg-[#222222] rounded-t-lg transition-colors duration-75'>
        <button
          ...
          className='flex gap-4 w-full py-2.5 pl-4 cursor-pointer'
        >
          <img
      ...
      <li className=' hover:bg-gray-100 cursor-pointer dark:hover:bg-[#222222] transition-colors duration-75'>
        <button
          onClick={() => dashContext!.setIsBlurred(true)}
          className='flex gap-3 w-full py-2.5 pl-4 pr-9 cursor-pointer'
          command='show-modal'
      ...
      <li
        ...
        className='hover:bg-gray-100 gap-3 cursor-pointer flex dark:hover:bg-[#222222] transition-colors duration-75 py-2.5 pl-4 pr-9'
      >
        <LightIcon
          width='20'
        ...
        <DarkIcon
          width='20'
          path='M484-80q-84 0-157.5-32t-128-86.5Q144-253 112-326.5T80-484q0-146 93-257.5T410-880q-18 99 11 193.5T521-521q71 71 165.5 100T880-410q-26 144-138 237T484-80Zm0-80q88 0 163-44t118-121q-86-8-163-43.5T464-465q-61-61-97-138t-43-163q-77 43-120.5 118.5T160-484q0 135 94.5 229.5T484-160Zm-20-305Z'
        />
      ...
      <li
        ...
        className=' hover:bg-red-100/40 cursor-pointer dark:hover:bg-red-900/20 rounded-b-lg  transition-colors duration-75 py-2.5 pl-4 pr-10 border-t border-gray-300 dark:border-gray-600 w-full '
      >
