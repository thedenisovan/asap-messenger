...
export default function ProfileDropdown() {
  ...
  return (
    ...
    >
      <li className='hover:bg-gray-100 gap-4 flex cursor-pointer dark:hover:bg-[#222222] rounded-t-lg transition-colors duration-75 py-3 pl-4'>
        <img
        ...
        <img
          ...
          alt='user profile img'
        />
        <p className='text-gray-800 dark:text-gray-200'>Profile Settings</p>
      </li>
      ...
      <li
        ...
        className='hover:bg-gray-100 gap-3 cursor-pointer flex dark:hover:bg-[#222222] transition-colors duration-75 py-3 pl-4 pr-9'
      >
      ...
      <li
        ...
        className=' hover:bg-red-100/40 cursor-pointer dark:hover:bg-red-900/20 rounded-b-lg  transition-colors duration-75 py-3 pl-4 pr-10 border-t border-gray-300 dark:border-gray-600 w-full '
      >
