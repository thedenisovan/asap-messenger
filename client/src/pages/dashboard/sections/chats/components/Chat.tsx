    ...
    <section>
      <header>
        {isLoading ? (
          ...
          <ChatHeader apiData={apiData}></ChatHeader>
        )}
      </header>
    </section>
  );
...
function ChatHeader({ apiData }: { apiData: ProfileData | null }) {
  return (
    <header className='p-4 border-b bg-white border-b-neutral-200 dark:bg-neutral-800 dark:border-b-neutral-800'>
