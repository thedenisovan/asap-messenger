...
function signupUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, username, password, profile, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, prisma_js_1.prisma.profile.create({
                            data: {
                                username: username,
                                email: email,
                ...
                case 3:
                    _b.sent();
                    return [2 /*return*/, res.status(200).json({ message: 'profile created' })];
                case 4:
                    error_1 = _b.sent();
                    return [2 /*return*/, res.status(404).json({ errorMessage: error_1 })];
